...
public class CRCUtil {
	...
	public static long computeFileCRC(String inputFile) throws RZPException {
	 ...
	 * @throws RZPException
	 */
	public static long computeFileCRC(String inputFile, ProgressMonitor progressMonitor) throws RZPException {
		
		if (!RZPUtil.isStringNotNullAndNotEmpty(inputFile)) {
			throw new RZPException("input file is null or empty, cannot calculate CRC for the file");
		}
		InputStream inputStream = null;
		try {
			RZPUtil.checkFileReadAccess(inputFile);
			...
			if (inputStream != null) {
				try {
					...
					throw new RZPException("error while closing the file after calculating crc");
				}
			}
		}
	}
