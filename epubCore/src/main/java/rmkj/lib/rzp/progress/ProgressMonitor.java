...
public class ProgressMonitor {
	...
	public void endProgressMonitorSuccess() throws RZPException {
		reset();
		result = ProgressMonitor.RESULT_SUCCESS;
	}
	
	public void endProgressMonitorError(Throwable e) throws RZPException {
		reset();
