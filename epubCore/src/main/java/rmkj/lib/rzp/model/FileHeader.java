...
public class FileHeader {
	 ...
	 * @throws RZPException
	 */
	public void extractFile(RZPModel zipModel, String outPath, 
	 ...
	 */
	public void extractFile(RZPModel zipModel, String outPath, 
			UnRZPParameters unzipParameters, ProgressMonitor progressMonitor, boolean runInThread) throws RZPException {
	 ...
	 */
	public void extractFile(RZPModel zipModel, String outPath, 
			UnRZPParameters unzipParameters, String newFileName, 
			ProgressMonitor progressMonitor, boolean runInThread) throws RZPException {
		if (zipModel == null) {
			throw new RZPException("input zipModel is null");
		}
		
		if (!RZPUtil.checkOutputFolder(outPath)) {
			throw new RZPException("Invalid output path");
		}
		
		if (this == null) {
			throw new RZPException("invalid file header");
		}
