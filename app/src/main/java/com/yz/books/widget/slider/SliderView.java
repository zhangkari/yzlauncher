package com.yz.books.widget.slider;
...
/*public class SliderView extends FrameLayout {
    ...
    public interface Callback {
        ...
        void onProgressChange(SliderView slider, int progress, int tickCount, boolean fromUser);

        void onTouchDown(SliderView slider, int progress, int tickCount, boolean hitThumb);

        void onTouchUp(SliderView slider, int progress, int tickCount);

        void onStartMoving(SliderView slider, int progress, int tickCount);

        void onStopMoving(SliderView slider, int progress, int tickCount);
    }
