...
@Entity(nameInDb = "book_category", createInDb = false)
public class BookCategory {
    ...
    @Generated(hash = 1876827666)
    public BookCategory(Long _id, String categorysName, int parentId) {
        this._id = _id;
        this.categorysName = categorysName;
        this.parentId = parentId;
    }

    @Generated(hash = 2089995418)
    public BookCategory() {
    }
