 ...
 */
class ThematicDetailVideoAdapter(context: Context, dataList: MutableList<ThematicDetailBean.ThematicDetailInfo>?) :
    YZBaseAdapter<ThematicDetailBean.ThematicDetailInfo>(R.layout.adapter_item_thematic_detail_video, dataList) {
