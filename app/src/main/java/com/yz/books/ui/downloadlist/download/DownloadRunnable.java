...
import com.yz.books.ui.downloadlist.download.okhttp.OkHttpManager;
import com.yz.books.ui.downloadlist.download.util.DownloadUtils;
...
public class DownloadRunnable implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            //保存文件的路径
            File file = new File(name);//new File(Environment.getExternalStorageDirectory().getAbsolutePath(), name);
