...
import com.gofun.zxing.R;
import com.gofun.zxing.bean.ZxingConfig;
import com.gofun.zxing.camera.CameraManager;
...
public final class ViewfinderView extends View {
    ...
    private Paint paint, cornerPaint, scanLinePaint, reactPaint, frameLinePaint;
    private Bitmap resultBitmap;
    private Bitmap mScannerBorderBitmap, mScannerLineBitmap;
    ...
    public ViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        maskColor = ContextCompat.getColor(getContext(), R.color.cB3ffffff);
        ...
        mScannerBorderBitmap = ((BitmapDrawable)getResources().
                getDrawable(R.drawable.ic_scanner_border)).getBitmap();
        mScannerLineBitmap = ((BitmapDrawable)getResources().
                getDrawable(R.drawable.ic_scanner_line2)).getBitmap();

        /*mLeftTopCornerBitmap = ((BitmapDrawable)getResources().
                getDrawable(R.drawable.ic_left_top_corner)).getBitmap();*/
    }
    ...
    private void initPaint() {
        ...
        cornerPaint.setStrokeWidth(dp2px(1));
    ...
    private void initAnimator() {
        ...
        if (valueAnimator == null) {
            valueAnimator = ValueAnimator.ofInt(frame.top + mSpace*3/2, frame.bottom - mSpace*3/2);
    ...
    public void setCameraManager(final CameraManager cameraManager, Context context) {
    ...
    private void drawMaskView(Canvas canvas, Rect frame, int width, int height) {
        ...
        /*上面的框*/
        canvas.drawRect(0, 0, width, frame.top, cornerPaint);
        /*绘制左边的框*/
        canvas.drawRect(0, frame.top, frame.left, frame.bottom + 1, cornerPaint);
        /*绘制右边的框*/
        canvas.drawRect(frame.right + 1, frame.top, width, frame.bottom + 1,
                cornerPaint);
        /*绘制下面的框*/
        canvas.drawRect(0, frame.bottom + 1, width, height, cornerPaint);

        //canvas.drawBitmap(mLeftTopCornerBitmap, frame.left, frame.top - 1, cornerPaint);
    }
    ...
    private void drawFrameBounds(Canvas canvas, Rect frame) {
        ...
        if (frameLineColor != -1) {
            ...
            //canvas.drawRoundRect(rectF, 50, 50, frameLinePaint);
        }
        ...
        Rect srcRect = new Rect(0, 0, mScannerBorderBitmap.getWidth(), mScannerBorderBitmap.getHeight());
        Rect destRect = new Rect(frame.left + mSpace, frame.top + mSpace,
                frame.right - mSpace, frame.bottom - mSpace);
        canvas.drawBitmap(mScannerBorderBitmap, srcRect, destRect, reactPaint);
    ...
    private void drawScanLight(Canvas canvas, Rect frame) {
        ...
        /*canvas.drawLine(frame.left + mSpace*3/2, scanLineTop,
                frame.right - mSpace*3/2, scanLineTop, scanLinePaint);*/

        canvas.drawBitmap(mScannerLineBitmap, frame.left, scanLineTop, scanLinePaint);
