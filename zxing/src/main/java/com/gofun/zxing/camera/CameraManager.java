...
package com.gofun.zxing.camera;
...
import com.gofun.zxing.common.Constant;
...
//    }
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int width = (int) (screenResolutionX * 0.7);
            int height = width;


            /*水平居中  偏上显示*/
            int leftOffset = (screenResolution.x - width) / 2;
            int topOffset = (screenResolution.y - height) / 2 - dp2px(20);
